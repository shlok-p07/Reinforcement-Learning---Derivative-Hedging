...
SAC_MODEL_PATH = "models/sac_hedger"

N_EPISODES = 200


def evaluate_strategy(strategy_name: str, model=None, sac_model=None):
    final_pnls = []
...
if __name__ == "__main__":
    ...
    strategies = ["no_hedge", "delta", "ppo", "sac"]

    for strat in strategies:

        pnls = evaluate_strategy(strat, model, sac_model)
